...
$message.="Please click on the link to reset your password http://localhost/parinata/changepswd.php \r\n\r\n";
$message.="Best Regards,\r\n";
$message.="";
$headers="from:chandanamanjunath1986@gmail.com";
$headers.="Content-type:text/html\r\n";
$appPassword = 'nwdg yodh ibwe rfyg';
...
<body >
    <nav class="navbar navbar-expand-md badge-dark navbar-red" style="width: 100%; background-color: #217c7e" >
    
    <a class="navbar-brand" style="color: white; font-size: 37px; font-family: serif;"><i  style="font-size:30px"></i>PARINATA</a>
    ...
    <form action="forgotpassword.php" method="POST">
                  ...
                  <input type="submit" value="Send Mail" class="sendmail" name="sendmail">
    </form>
</div>
</div>
</body>
